@ Program 1a: Celsius to Fahrenheit Conversion
...
.section .data
    prompt_msg:     .asciz "Enter temperature in Celsius: "
    scanf_format:   .asciz "%d"
    printf_format:  .asciz "Temperature in Fahrenheit: %d\n"
...
main:
    ...
    mov r0, #0
    str r0, [r11, #-4]      @ celsius
    str r0, [r11, #-8]      @ fahrenheit
    
    @ Main conversion loop
    b celsius_input_loop
...
celsius_input_loop:
    ...
    @ Check for reasonable temperature range (-200 to 1000)
    cmp r0, #-200        @ Lower bound
    blt input_error
    cmp r0, #1000        @ Upper bound
    bgt input_error
